...
#include <memory>
#include "thirdparty/qjson/serializerrunnable.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QJson__SerializerRunnable_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QJson__SerializerRunnable_t qt_meta_stringdata_QJson__SerializerRunnable = {
    {
QT_MOC_LITERAL(0, 0, 25), // "QJson::SerializerRunnable"
QT_MOC_LITERAL(1, 26, 15), // "parsingFinished"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 10), // "serialized"
QT_MOC_LITERAL(4, 54, 2), // "ok"
QT_MOC_LITERAL(5, 57, 9) // "error_msg"

    },
    "QJson::SerializerRunnable\0parsingFinished\0"
    "\0serialized\0ok\0error_msg"
};
...
void QJson::SerializerRunnable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SerializerRunnable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SerializerRunnable::*)(const QByteArray & , bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerializerRunnable::parsingFinished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QJson::SerializerRunnable::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QJson__SerializerRunnable.data,
    qt_meta_data_QJson__SerializerRunnable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QJson::SerializerRunnable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QJson__SerializerRunnable.stringdata0))
