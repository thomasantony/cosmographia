...
#include <memory>
#include "thirdparty/qjson/parserrunnable.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QJson__ParserRunnable_t, stringdata0) + ofs \
...
void QJson::ParserRunnable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ParserRunnable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ParserRunnable::*)(const QVariant & , bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ParserRunnable::parsingFinished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QJson::ParserRunnable::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QJson__ParserRunnable.data,
    qt_meta_data_QJson__ParserRunnable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QJson::ParserRunnable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QJson__ParserRunnable.stringdata0))
